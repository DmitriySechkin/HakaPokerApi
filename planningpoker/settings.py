...
SECRET_KEY = 'django-insecure-8l_y!8j0@@k%sb(zctg$a$qy9%js0#gha+o@3z1%wu9o3i6wvn'
...
SUID_ALPHABET = 'abcdefghij'#os.environ.get('PLANNING_POKER_SUID_ALPHABET')
SUID_LENGTH = 10

JWT_SECRET_KEY = 'abcdefghij'#os.environ.get('PLANNING_POKER_SUID_ALPHABET')
